...
export const initCommand = new Command('init')
  ...
  .action((options) => {
    ...
    console.log('');
    console.log('     # Option A: Interactive setup (recommended)');
    console.log('     bellwether auth');
    console.log('');
    console.log('     # Option B: Global .env file');
    console.log('     mkdir -p ~/.bellwether && echo "OPENAI_API_KEY=sk-xxx" >> ~/.bellwether/.env');
    console.log('');
    console.log('     # Option C: Project .env file');
